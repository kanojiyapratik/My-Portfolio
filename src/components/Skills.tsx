    ...
    <section id="skills" className="py-20 bg-gradient-to-b from-[#181824] via-[#232946] to-[#1a1a2e] scroll-mt-16 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          <h3 className="text-xl sm:text-2xl font-semibold text-center text-cyan-200 mb-6 sm:mb-8">
            Core Competencies
          </h3>
            ...
            {coreSkills.map((skill, index) => (
              <div key={index} className="space-y-2 animate-slide-up">
                <div className="flex justify-between items-center">
                  <span className="text-purple-200 font-medium text-sm sm:text-base">{skill.name}</span>
                  <span className="text-purple-200 font-semibold text-sm sm:text-base">{skill.level}%</span>
                </div>
                <div className="w-full bg-border rounded-full h-2 sm:h-2.5">
                  <div 
